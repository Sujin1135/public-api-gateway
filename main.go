...
import (
	...
	gatewayHttp "github.com/we-are-flower/public-api-gateway/http"
...
func startServer() {
	...
	// example sub-graph servers
	datasourceWatcher := NewDatasourcePoller(httpClient, DatasourcePollerConfig{
		Services: []ServiceConfig{
			{Name: "user-auth", URL: "http://localhost:4001/query", Fallback: fallback},
			{Name: "store", URL: "http://localhost:4002/query", WS: "ws://localhost:4002/query"},
